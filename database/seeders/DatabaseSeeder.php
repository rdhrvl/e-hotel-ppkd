...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $rooms = [
            ...
            ['room_number' => '101', 'room_type_id' => $executive->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 1, 'notes' => 'Balcony view'],
            ['room_number' => '102', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'reserved', 'floor' => 1, 'notes' => 'Extra clean requests'],
            ['room_number' => '103', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'occupied', 'floor' => 1, 'notes' => 'Double single beds'],
            ['room_number' => '104', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 1, 'notes' => 'Near stairs'],
            ['room_number' => '105', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 1, 'notes' => 'Double single beds'],
            ['room_number' => '106', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 1, 'notes' => 'City view'],
            ['room_number' => '107', 'room_type_id' => $suite->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 1, 'notes' => 'Corner suite'],
            ['room_number' => '108', 'room_type_id' => $executive->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 1, 'notes' => 'Balcony view'],
            ...
            ['room_number' => '115', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 1, 'notes' => 'Extra clean requests'],
            ['room_number' => '116', 'room_type_id' => $suite->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 1, 'notes' => ''],
            ['room_number' => '117', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 1, 'notes' => 'Quiet area'],
            ...
            ['room_number' => '120', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 1, 'notes' => 'Near elevator'],

            // Floor 2 (201 - 220) — Mixed Room Types
            ['room_number' => '201', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 2, 'notes' => 'Garden view'],
            ['room_number' => '202', 'room_type_id' => $suite->id, 'branch_id' => $branch1->id, 'status' => 'occupied', 'floor' => 2, 'notes' => ''],
            ...
            ['room_number' => '206', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 2, 'notes' => ''],
            ['room_number' => '207', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 2, 'notes' => 'Street view'],
            ['room_number' => '208', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 2, 'notes' => 'Street view'],
            ...
            ['room_number' => '213', 'room_type_id' => $suite->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 2, 'notes' => 'Family stay'],
            ...
            ['room_number' => '216', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 2, 'notes' => 'Near stairs'],
            ['room_number' => '217', 'room_type_id' => $executive->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 2, 'notes' => 'Skyline view'],
            ...
            ['room_number' => '220', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 2, 'notes' => 'Street view'],
            ...
            ['room_number' => '306', 'room_type_id' => $suite->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 3, 'notes' => 'VIP suite'],
            ['room_number' => '307', 'room_type_id' => $suite->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 3, 'notes' => ''],
            ['room_number' => '308', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 3, 'notes' => 'Near stairs'],
            ...
            ['room_number' => '311', 'room_type_id' => $executive->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 3, 'notes' => 'Skyline view'],
            ['room_number' => '312', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 3, 'notes' => 'Quiet area'],
            ['room_number' => '313', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 3, 'notes' => 'Near stairs'],
            ...
            ['room_number' => '318', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 3, 'notes' => 'City view'],
            ['room_number' => '319', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 3, 'notes' => 'City view'],
            ['room_number' => '320', 'room_type_id' => $executive->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 3, 'notes' => 'Skyline view'],
            ...
            ['room_number' => '406', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 4, 'notes' => 'Pool view'],
            ...
            ['room_number' => '412', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 4, 'notes' => 'Garden view'],
            ['room_number' => '413', 'room_type_id' => $suite->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 4, 'notes' => ''],
            ...
            ['room_number' => '416', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 4, 'notes' => 'Quiet area'],
            ['room_number' => '417', 'room_type_id' => $executive->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 4, 'notes' => ''],
            ['room_number' => '418', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 4, 'notes' => 'Street view'],
            ['room_number' => '419', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 4, 'notes' => 'Quiet area'],
            ...
            ['room_number' => '503', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 5, 'notes' => 'Street view'],
            ...
            ['room_number' => '507', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 5, 'notes' => 'Quiet area'],
            ['room_number' => '508', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 5, 'notes' => 'Street view'],
            ['room_number' => '509', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 5, 'notes' => 'City view'],
            ['room_number' => '510', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 5, 'notes' => 'Street view'],
            ['room_number' => '511', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 5, 'notes' => 'Double single beds'],
            ...
            ['room_number' => '517', 'room_type_id' => $executive->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 5, 'notes' => ''],
            ['room_number' => '518', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 5, 'notes' => 'Garden view'],
            ['room_number' => '519', 'room_type_id' => $deluxe->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 5, 'notes' => 'Garden view'],
            ['room_number' => '520', 'room_type_id' => $standard->id, 'branch_id' => $branch1->id, 'status' => 'available', 'floor' => 5, 'notes' => 'Extra clean requests'],
        ];
