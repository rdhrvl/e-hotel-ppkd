<div>
    ...
    <form wire:submit.prevent="login" class="space-y-5">
        ...
        <button type="submit" class="w-full rounded bg-[var(--text-primary)] hover:bg-[var(--text-secondary)] px-4 py-3 text-sm font-semibold text-[var(--bg-card)] transition-all duration-150 active:scale-[0.98]" wire:loading.attr="disabled">
            <span wire:loading.remove>Sign In</span>
            <span wire:loading.flex class="inline-flex items-center gap-2 justify-center">
