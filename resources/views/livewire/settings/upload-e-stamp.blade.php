<div class="card" style="max-width: 500px; margin: 0 auto;">
    <h3 class="mb-2" style="font-size: 1.25rem;">Digital Stamp (E-Stamp)</h3>
    <p class="mb-6" style="font-size: 0.85rem; color: var(--text-muted);">Upload your warehouse verification stamp file. Supported formats: JPG, PNG, PDF (max 2MB).</p>
    ...
    <form wire:submit.prevent="upload">
        ...
        @if($existingUpload)
            <div class="mb-6" style="border-top: 1px solid var(--border-color); padding-top: 16px;">
                <label class="form-label mb-2">Current Active E-Stamp</label>
                ...
                @else
                    <div style="text-align: center; background-color: #0b0b16; border-radius: var(--radius); border: 1px solid var(--border-color); padding: 16px;">
                        <img src="{{ Storage::url($existingUpload->file_path) }}" alt="E-Stamp Preview" style="max-height: 120px; max-width: 100%; object-fit: contain;">
